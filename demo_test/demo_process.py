...
class DemoTest(QObject):
	...
	def meter_test_mode_balance(self, base_save_path, search_pattern):
		...
		self.config_setup_action(
			...
			apply_btn=None,
			roi_keys=default_roi_keys,
			correct_answers=ConfigROI.m_anal_vol_symm_ll_fixed_text.value,
		...
		self.config_setup_action(
			...
			apply_btn=None,
			roi_keys=default_roi_keys,
			correct_answers=ConfigROI.m_anal_vol_symm_ln_fixed_text.value,
		...
		self.config_setup_action(
			...
			ratio_rules=tmb.anal_vol_symm_ln_ratio.value,
			meas_rules=tmb.anal_vol_symm_ln.value,
			addr_meas=[ConfigMap.addr_meas_vol_positive_sequence_max_ln.value, ConfigMap.addr_meas_vol_negative_sequence_max_ln.value, ConfigMap.addr_meas_vol_zero_sequence_max_ln.value],
			aggre_selection=255,
			addr_timestamp=None,
			reset_time=reset_time,
			modbus_unit=None,
		...
		self.config_setup_action(
			...
			ratio_rules=tmb.anal_vol_unbal_ratio.value,
			meas_rules=tmb.anal_vol_unbal.value,
			addr_meas=[ConfigMap.addr_meas_vol_unbalance_max_ll.value, ConfigMap.addr_meas_vol_unbalance_max_ln.value, ConfigMap.addr_meas_vol_negative_unbalance_max.value, ConfigMap.addr_meas_vol_zero_unbalance_max.value],
			aggre_selection=255,
			addr_timestamp=None,
			reset_time=reset_time,
			modbus_unit=None,
		...
		self.config_setup_action(
			...
			apply_btn=None,
			roi_keys=default_roi_keys,
			correct_answers=ConfigROI.m_anal_curr_symm_fixed_text.value,
			ratio_rules=tmb.anal_curr_symm_ratio.value,
			meas_rules=tmb.anal_curr_symm.value,
			addr_meas=[ConfigMap.addr_meas_curr_positive_sequence.value, ConfigMap.addr_meas_curr_negative_sequence.value, ConfigMap.addr_meas_curr_zero_sequence.value,],
			aggre_selection=1,
			addr_timestamp=None,
			reset_time=None,
			modbus_unit=None,
		...
		self.config_setup_action(
			...
			ratio_rules=tmb.anal_curr_symm_ratio.value,
			meas_rules=tmb.anal_curr_symm.value,
			addr_meas=[ConfigMap.addr_meas_curr_positive_sequence_max.value, ConfigMap.addr_meas_curr_negative_sequence_max.value, ConfigMap.addr_meas_curr_zero_sequence_max.value,],
			aggre_selection=255,
			addr_timestamp=None,
			reset_time=reset_time,
			modbus_unit=None,
		...
		self.config_setup_action(
			...
			apply_btn=None,
			roi_keys=default_roi_keys,
			correct_answers=ConfigROI.m_anal_curr_unbal_fixed_text.value,
			ratio_rules=tmb.anal_curr_unbal_ratio.value,
			meas_rules=tmb.anal_curr_unbal.value,
			addr_meas=[ConfigMap.addr_meas_curr_unbalance.value, ConfigMap.addr_meas_curr_negative_unbalance.value, ConfigMap.addr_meas_curr_zero_unbalance.value,],
			aggre_selection=1,
			addr_timestamp=None,
			reset_time=None,
			modbus_unit=None,
		...
		self.config_setup_action(
			...
			ratio_rules=tmb.anal_curr_unbal_ratio.value,
			meas_rules=tmb.anal_curr_unbal.value,
			addr_meas=[ConfigMap.addr_meas_curr_unbalance_max.value, ConfigMap.addr_meas_curr_negative_unbalance_max.value, ConfigMap.addr_meas_curr_zero_unbalance_max.value,],
			aggre_selection=255,
			addr_timestamp=None,
			reset_time=reset_time,
			modbus_unit=None,
